...
//      <button
//       className="mb-6 flex w-full items-center justify-center rounded-md bg-white p-3 text-base font-medium shadow-one text-primary dark:bg-white dark:shadow-signUp dark:text-black"
