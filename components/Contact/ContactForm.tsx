        ...
        <div className="-mx-4 flex flex-wrap ">
          <div className="w-full  lg:w-7/12 xl:w-8/12 ">
            <div
              ...
              "
            >
              <div className="flex min-h-screen flex-col  justify-start sm:justify-center py-6 sm:py-4">
                <div className="relative py-3 sm:mx-auto sm:max-w-xl">
                  ...
                  <div className=" px-10 py-10 sm:p-16  relative rounded-3xl bg-gradient-to-br from-pink-400 to-sky-200   text-white shadow-lg dark:bg-gradient-to-br dark:from-pink-700 dark:to-sky-500">
                    ...
                    >
                      ...
                      <div className="flex justify-between gap-3 sm:gap-5">
                        <input
                          className="
                          md:text-md text-[11px] sm:text-sm
                          
                          focus:shadow-outline w-36  rounded-lg bg-gradient-to-br  from-indigo-500  to-indigo-200 p-1 sm:py-2 sm:px-4 px-1 font-bold text-black hover:bg-indigo-700 hover:from-indigo-500 hover:to-indigo-200 focus:outline-none dark:text-white"
                          type="submit"
                          value="Send ➤"
                        />
                        <input
                          className="
                          md:text-md text-[11px]  sm:text-sm
                          focus:shadow-outline w-36  rounded-lg bg-gradient-to-br from-red-500 to-red-200 p-1 sm:py-2 sm:px-4 px-1 font-bold text-black shadow-xl hover:bg-red-700 hover:bg-gradient-to-tl hover:from-red-500 hover:to-red-200  focus:outline-none dark:text-white"
                          type="reset"
                        />
                      </div>
                    </form>
...
//                   <div className="relative bg-gradient-to-br from-pink-400 to-sky-200 dark:bg-gradient-to-br dark:from-pink-700 dark:to-sky-500  text-white shadow-lg sm:rounded-3xl px-4 py-10 sm:p-20">
//                     <div className="pb-6 text-center">
