...
const SigninPage = () => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // if (response.error) {
    //   setGoogleMessage("Failed to sign in with Google.");
    //   setGoogleStatus("error");
    //   setLoading(false); // Set loading to false
    //   return;
    // }
                    ...
                    <>
                      <span className="mr-3 animate-spin">
                        ...
                        >
                          <path
                            fillRule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-14a1 1 0 00-2 0v4.586l-1.293-1.293a1 1 0 00-1.414 1.414l3 3a1 1 0 001.414 0l3-3a1 1 0 00-1.414-1.414L11 8.586V4z"
                            clipRule="evenodd"
                          />
                        </svg>
                      </span>
