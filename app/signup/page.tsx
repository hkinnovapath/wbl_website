...
//         if (response.ok) {
//           // Display success messagee if registration was successful
//           setMessagee(data);
//         } else {
//           // Display error messagee if registration failed
//           // setMessagee(data.error || "Registration failed");
//           setMessagee(data.error);
//         }
//       } catch (error) {
                ...
                >
                  ...
                  {messagee && (
                    ...
                    >
                      ...
                      <span className="block sm:inline">{messagee}</span>
                    </div>
                  )}
                </form>
                <p className="text-center text-base font-medium text-black dark:text-white">
