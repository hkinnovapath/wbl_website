...
//   return (
//     <div
//       className="wow fadeInUp relative top-1/4 z-10 flex  flex-col justify-center rounded-2xl  bg-primary/[3%] bg-gradient-to-br   from-pink-400 to-sky-200  p-8 text-black shadow-lg dark:bg-primary/10 dark:bg-gradient-to-br dark:from-pink-700 dark:to-sky-500 dark:text-white sm:p-11 lg:p-8 xl:p-11"
//       data-wow-delay=".2s"
//     >
