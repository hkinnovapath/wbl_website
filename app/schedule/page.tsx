    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="mb-8 flex flex-col sm:flex-row sm:justify-between">
          {/* Left side */}
          <div className="mt-10 flex flex-col sm:w-1/6">
            <button
              className="mb-2 rounded-md bg-blue-500 bg-gradient-to-br from-primary to-blue-300 px-4 py-2 text-sm font-bold text-black hover:bg-blue-600 hover:bg-gradient-to-tl hover:from-primary hover:to-blue-300 sm:text-base lg:text-lg"
              onClick={() => handleButtonClick("calendar")}
            >
              Calendar
            </button>
