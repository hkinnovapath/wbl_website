...
// import WBLdark from "@/public/images/wbl-dark.png"; // Replace with the actual path
// import { useRouter } from "next/navigation";
// import { isAuthenticated as checkAuthentication } from "@/utils/auth"; // Update with the correct path
...
//     window.addEventListener("storage", fetchAuthStatus);
//     return () => window.removeEventListener("storage", fetchAuthStatus);
//   }, []);
